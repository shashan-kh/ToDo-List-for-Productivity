...
displayList = list => {
    ...
    list.map( elem => {
        ...
        if (elem.completed) tag.setAttribute("class", "checked");
            ...
            if(elem.priority == "High") tag.setAttribute("class","HighBg");
            if(elem.priority == "Medium") tag.setAttribute("class","MediumBg");
            if(elem.priority == "Low") tag.setAttribute("class","LowBg");
        ...
        // // console.log(li);
        // var priorityGet = elem.priority;
        // console.log(elem.priority);
        // if(priorityGet == "High"){
        //     li.style.backgroundColor = "red";
        // }
        // if(priorityGet == "Medium"){
